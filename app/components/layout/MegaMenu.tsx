            ...
            <div key={category.name} className="relative flex items-center">
              ...
              {category.subcategories && openCategory === category.name && (
                <div
                  ...
                  onMouseEnter={() => handleCategoryHover(category.name)}
                >
                  <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-10 py-8">
                    {/* Main subcategories */}
                    <div className="col-span-1 lg:col-span-2 xl:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-10">
